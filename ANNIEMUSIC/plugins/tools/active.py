...
async def activevc(_, message: Message):
    mystic = await message.reply_text("» Aktif sesli sohbetler listesi alınıyor...")
    ...
    for x in served_chats:
        ...
        try:
            ...
            continue
    if not text:
        await mystic.edit_text(f"» Hiçbir aktif sesli sohbet yok {app.mention}.")
    else:
...
async def activevi_(_, message: Message):
    mystic = await message.reply_text("» Aktif video sohbetler listesi alınıyor...")
    ...
    for x in served_chats:
        ...
        try:
            ...
            continue
    if not text:
        await mystic.edit_text(f"» Aktif video sohbeti yok {app.mention}.")
    else:
        await mystic.edit_text(
            f"<b>» Şu anda aktif olan video sohbetlerin listesi :</b>\n\n{text}",
            disable_web_page_preview=True,
        )
